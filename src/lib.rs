...
#[derive(Debug)]
pub struct UltraAuroraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UltraAuroraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UltraAurora processing");
    
    let mut processor = UltraAuroraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UltraAuroraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UltraAuroraProcessor::new(false);
